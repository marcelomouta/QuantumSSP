# QuantumSSP
A quantum circuit that solves a variation of the [Subset Sum Problem](https://en.wikipedia.org/wiki/Subset_sum_problem) (SSP) in which all the inputs are positive and all the subsets are found.
